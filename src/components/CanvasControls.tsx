      ...
      <div className="grid grid-cols-2 gap-2">
        <div className="space-y-1">
          ...
          <input
            type="number"
            value={config.width}
            onChange={(e) => setConfig({ width: parseInt(e.target.value) || 100, sizePreset: "custom" })}
        ...
        <div className="space-y-1">
          ...
          <input
            type="number"
            value={config.height}
            onChange={(e) => setConfig({ height: parseInt(e.target.value) || 100, sizePreset: "custom" })}
            className="w-full rounded-md border border-border bg-secondary px-2 py-1 text-xs text-foreground"
          />
        </div>
      </div>
        ...
        <>
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={cn(
                ...
                config.showBackground ? "bg-primary text-primary-foreground" : "bg-secondary text-secondary-foreground"
              )}
            >
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={cn(
                "rounded-full px-3 py-0.5 text-[10px] font-medium transition-all",
                config.transparentBackground ? "bg-primary text-primary-foreground" : "bg-secondary text-secondary-foreground"
              )}
            >
