      ...
      <div className="grid grid-cols-2 gap-2">
        <div className="space-y-1">
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <span className="font-mono text-[10px] text-muted-foreground">{config.foregroundColor}</span>
          </div>
        </div>
        <div className="space-y-1">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="h-7 w-7 cursor-pointer rounded border-0 bg-transparent p-0"
            />
            <span className="font-mono text-[10px] text-muted-foreground">{config.backgroundColor}</span>
          </div>
        </div>
      </div>
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className={cn(
            ...
            config.invertColors ? "bg-primary text-primary-foreground" : "bg-secondary text-secondary-foreground"
          )}
        >
